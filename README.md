...
|overScroll|string|`none`|When dragging an item outside the scrollable container will allow scrolling to continue rather than stopping. Can be **none** or **x** or **y** or **both**.
